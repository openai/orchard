...
func (x *WatchInstruction) GetResolveIpAction() *WatchInstruction_ResolveIP {
	if x, ok := x.GetAction().(*WatchInstruction_ResolveIpAction); ok {
...
func file_orchard_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_orchard_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_orchard_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_orchard_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*ResolveIPResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_orchard_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_orchard_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_orchard_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*WatchInstruction_ResolveIP); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
